...
public class BalanceController {
    ...
    @PostMapping("/topup")
    public String topUp(@AuthenticationPrincipal CustomUserDetails userDetails, RedirectAttributes redirectAttributes, @RequestParam("amount") BigDecimal amount) {
    ...
    public String withdraw(@AuthenticationPrincipal CustomUserDetails userDetails, RedirectAttributes redirectAttributes, @RequestParam("amount") BigDecimal amount) {
        Long userId = userDetails.getUserId();
        try {
